...
!function (a, b) {
    ...
    }), o.focusin = "onfocusin" in a, o.focusin || r.each({afterprint: "focusin", afterprint: "focusout"}, function (a, b) {
        var c = function (a) {
            r.event.simulate(b, a.target, r.event.fix(a))
        };
        //AS ALTERAÇÕES ACIMA FORAM REALIZADAS POR CONTA DA ATUALIZAÇÃO DO NAVEGADOR
        //FOI ALTERADO O (FOCUS) PARA AFTERPRINT PARA EVITAR ERRO NO RETORNO
        r.event.special[b] = {
            setup: function () {
